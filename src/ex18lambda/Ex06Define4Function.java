...
Function
	...
	추상메소드를 가지고 있음
	-위 메소드는 매개값과 리턴값으로 타입변환(매핑)하는 역할을 함.
 */
public class Ex06Define4Function {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lambda 문자열의 길이="+func.apply("Lambda"));
		System.out.println("LambdaExpression 문자열의 길이="+func.apply("LambdaExpression"));
