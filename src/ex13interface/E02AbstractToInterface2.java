...
interface PersonalNumberStoreageInter{
...
인터페아스가 인터페이스를 상속받을때 => extends 사용
 
extends는 '상속'이라고 표현하고, implements는 '구현'이라 표현한다.
 */
class PersonalNumberStorageImpl implements PersonalNumberStoreageInter{
	//멤버변수
	...
	/*
	 주민번호를 인자로 받아 객체배열애 저장된 정보를 검색한후
	 일치하는 경우에만 이름을 반환한다.
	 */
	@Override
...
public class E02AbstractToInterface2 {
	...
	public static void main(String[] args) {
		...
		PersonalNumberStoreageInter storage = new PersonalNumberStorageImpl(10);
		//정보저장
