...
추상클래스2 - 추상메소드를 포함한 클래스
	...
	정의해야한다. class 앞에 abstract를 지우면 에러가
	발생한다.
 */
...
public class E01AbstractBasic {
	...
	public static void main(String[] args) {
		...
		((absClassChild2)absClass2).newMethod();/*
			...
			다운캐스팅(강제형변환) 후 접근해야한다.
		*/
		
		/*
		추상클래스내에 선언된 정적멤버는 오버라이딩의대상이
