...
public class E05FilterDataBufferStream {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//3개의 스트림을 한번에 생성한다.
			DataInputStream dataFileterIn = 
					new DataInputStream(new BufferedInputStream(new FileInputStream(src)));
			
			//각각의 데이터를 읽어옴
			int intNum1 = dataFileterIn.readInt();
			double dblNum1 = dataFileterIn.readDouble();
			int intNum2 = dataFileterIn.readInt();
			double dblNum2 = dataFileterIn.readDouble();
			
			dataFileterIn.close();
			
			System.out.printf("저장된 정수는 %d, %s\n", intNum1, intNum2);
