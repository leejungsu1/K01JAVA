...
아래 main함수에 부합하는 CalculatorEx 클래스를 정의하면되고 해당 수치는 임의로 바꿔도
된다. init() 멤버메소드에서는 계산의 결과를 카운트하는 멤버변수를 0으로 초기화 한다.
실행결과]
1 + 2 = 3.0
10.5 - 5.5 = 5.0
4.0 * 5.0 = 20.0
...
class CalculatorEx{
	...
	public double add(int n1, int n2) {
		addVal++;//addVal += 1 도 가능(덧셈연산횟수카운트)
		return n1 + n2;
	}
...
//	int addSum, minSum, mulSum, divSum;
...
//	}
//	void showOpCount(){
//		System.out.println("덧셈횟수 : "+addSum);
//		System.out.println("뺄셈횟수 : "+minSum);
//		System.out.println("곱셈횟수 : "+mulSum);
//		System.out.println("나눗셈횟수 : "+divSum);
//	}
//	void init() {
//		addSum = 0;
//		minSum = 0;
