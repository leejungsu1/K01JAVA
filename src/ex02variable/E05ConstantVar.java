...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		...
		선언방법 : final자료형 변수명=초기값;
		-상수는 딱 한번만 초기화되며, 중간에 값을 변경하면 에러발생됨
		-선언시 전체를 대문자로 선언하며, 연결되는 단어가 있는경우_(언더바)를 사용한다.
	...
	/*
	1,3은 개발자 본인만 알수있는 내용이므로, 가독성이 떨어지는 코드로 작성되었다.
	 */
	computer = 1;
	user = 3;
	...
	/*
	PAPER와 같은 단어는 누가 보더라도 이해할수 있으므로 가독성이 높은 명시적인 코드가 된다.
	 */
	computer = SCISSOR;
	user = PAPER;
