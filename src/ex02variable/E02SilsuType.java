...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		실수자료형
		-정수형보다 실수형이 더 큰 자료형이다.(0과 1사이에 무수한 실수가 존재하기 때문)
		...
		방법2 : 계산결과 전체를 long으로 명시적(강제)형변환한다.
		 */
		...
		-형변환도 가능하지만 JAVA에서 권장하지 않는다.
		 */
		float f3 = 100;
		
		//float f4 = 3.14;[에러발생]=> 3.14 자체를 double형으로 인식함.
		float f4 = (float)3.14;//형변환후 대입(권장사항아님)
		System.out.println("f4="+ f4);
		
		float f5 = 3.14F;//자바에서 접미사사용을 권장하고 있음.
