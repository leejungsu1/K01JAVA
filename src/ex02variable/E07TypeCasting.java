...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		자동형변환 : 작은상자의 데이터를 큰상자에 대입할때 자동으로
			형변환이 일어난다.
		 */
		byte b1 = 65;
		short s1;
		...
		/*
		char형(문자타입)에 byte형(숫자타입)을 바로 대입할수없다.
		성질이 다르므로 명시적형변환후 대입해야한다.
		 */
		//char ch1 = b1; //에러발생
		char ch2 = (char)b1;
		...
		/*
		명시적 형변환  : 큰상자의 자료를 작은상자의 자료형에 할당해야할때
		...
		/*
		소수점 아래부분이 버려지므로 데이터 손실됨. 따라서 특수한 경우가
		아니라면 사용을 자제하는것이 좋다.
		 */
		int num3;
		double dl = 3.14;
		...
		//ch4 = ch3 + num4; //타입이 맞지않아 에러발생. ch4는 char형, ch3 + num4는 int형
		ch4 = (char)(ch3 + num4);
