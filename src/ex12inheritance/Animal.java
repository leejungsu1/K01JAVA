...
public class Animal {
	...
	String gender;
	/*
	부모클래스의 멤버가 private인 경우 자식클래스에서 
	접근이 불가능하므로 반드시 getter(외부클래스에서 값을 가져오는 것) / 
	setter(외부클래스에서 값을 바꾸는것)메소드를 통해 접근해야한다.
	 */
	public String getSpecies() {
		return species;
	}
	//생성자
	public Animal(String spcies, int age, String gender) {
		this.species = spcies;
		this.age = age;
		this.gender = gender;
	}
