...
오버라이딩 : 함수명, 매개변수, 반환형까지 모두 동일한 함수를
	...
	가리게 되므로 항상 하위클래스의 메소드가 호출되게 된다.
...
public class E07RideAndLoad01 {
	...
	public static void main(String[] args) {
		...
		호출된다. 즉 아래부분은 모두 C클래스에 생성된 메소드가
		호출된다.
		 */
		...
		참조변수로 참조할수없다. 자식타입의 참조변수로
		부모객체를 참조하는것은 불가능하다.
		 */
		//B refId2 = refId1;
		//C refId3 = refId1;
		
		//아래와 같이 다운캐스팅(강제형변환)하면 참조가능하다.
		C refId3 = (C)refId1;
	}
}
