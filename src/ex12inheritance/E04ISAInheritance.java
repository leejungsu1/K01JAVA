...
class Computer{
	...
	상속관계라면 protected로 선언된 메소드도 호출할수있다.
	 */
...
class NotebookComputer extends Computer{
	...
	/*
	부모생성자 호출을 위해 사용하는 super()는 생략은 가능하지만(위에 디폴트 생성자나 
	기본생성자[public NotebookComputer() {}]가 있어야 생략가능)
	앞에 다른 문장이 먼저 오게 되면 오류가 발생되므로 주의해야한다.
	 */
	...
	public void movinCal() {
		...
		/*
		아래 메소드는 private으로 선언되었으므로 
		상속받은 자식클래스에서도 접근이 불가능하다.
		 */
		//keyboardTouch();//에러발생
		//calculate();//에러발생
...
class TableNotebook extends NotebookComputer{
	...
	//테블릿 사용을 위해 베터리양 체크 및 등록된 펜인지 체크
...
public class E04ISAInheritance {
	...
	public static void main(String[] args) {
		...
		System.out.println("==XYZ-9876펜으로 테블릿사용==");
		tablet.write("WXZ-9876");//사용불가
	}
}
