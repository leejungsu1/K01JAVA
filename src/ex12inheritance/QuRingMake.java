...
/*
다음 Point클래스를 이용하여 다음 문제를 해결하시오. 해당 문제는 상속을 통해 구현하는것이 아니라
구성관계를 이용하여 해결한다. Point 클래스를 기반으로 원을 의미하는 Circle클래스를 정의하자. 
그리고 Circle클래스를 기반으로 Ring클래스를 정의하자(중심점이랑 x,y좌표필요)
실행결과]
안쪽원의 정보 :
반지름 : 3	
[x좌표:1, y좌표1]
...
class Circle{	
	...
	//생성자
	/*
	반지름을 표현하는 radian과 중심좌표를 표현하는 Point객체생성
	Point객체생성을 위해서는 2개의 인자가 필요.
	 */
