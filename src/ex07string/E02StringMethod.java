...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("ABC".compareTo("ABC")==0 ?
				"문자열이 같다" : "문자열이 다르다");
		/*
		5] concat() : 두갸의 문자열을 연결할때 사용한다. +기호와
			동일한 역할을 한다.
		 */
		...
		판단하여 포함되었다면 true, 아니면 false를 반환한다.
		 */
		...
		System.out.println("indexOf:" +
				str1.indexOf("a"));//12(앞에있는 a의 인덱스)
		System.out.println("lastIndexOf:" +
				str1.lastIndexOf("a"));//14(뒤에있는 a의 인덱스)
		/*
		12] replace()
		...
		*/
		...
		int beginIdex = filename.lastIndexOf(".") + 1;
		System.out.println("파일의 확장자는:" +
			filename.substring(beginIdex));
		}
	}
}
