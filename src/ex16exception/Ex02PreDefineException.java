...
-RuntimeException클래스계열로 NullPointException이
대표적인 하위클래스이다.
...
public class Ex02PreDefineException {
	...
	public static void main(String[] args) {
		...
		: 숫자형식의 문자열을 int로 변환하는 경우 해당 문자열이
		숫자형식이 아니면 발생되는 예외
		 */
		 ...
		 */
		System.out.println("### NullPointExcetion ###");
		System.out.println("toDay="+toDay);/*
							toDay참조변수가 가지고 있는 null값을
		...
		try {
			...
			System.out.println("toDay 참조변수는null입니다.");
			System.out.println("예외메세지:"+ e.getMessage());
			e.printStackTrace();
		}
		/*
		5]ArithmeticExcetion
		...
		try {
			...
			System.out.println("형변환 할 수없습니다.");
