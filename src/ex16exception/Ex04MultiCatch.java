...
public class Ex04MultiCatch {
	...
	public static void main(String[] args) {
		/*
		예외처리를 할때 필요에 따라 여러개의 catch블럭을 사용할 수있다.
		...
		try {
			...
			System.out.println("배열에 저장된 두 숫자 나누기:"+ array[0]/array[1]);//테스트시 0 입력할것
			
			System.out.print("나이를 입력하시오:");
			int age = scanner.nextInt();
			//나이 입력시 숫자이외의 문자를 입력 할것
			...
			System.out.println("숫자형태의 문자만 입력이 가능합니다.");
		}
