...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		언박싱하기위해 intValue()와 같은 메소드를 통해 값을
		꺼내온다.
		 */
		...
		System.out.println("결과값을 이진수로 변경:"+ resultObj.toBinaryString(result2));
		...
		/*
		Wrapper클래스를 사용하는 이점
			: Wrapper클래스에 정의된 많은 메소드를 사용할수있다.
