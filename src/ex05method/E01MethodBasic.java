...
public class E01MethodBasic {
	...
	/*
	메소드 정의1 : 반환타입 O, 매개변수 O 의 형태로 정의
	...
	/*
	메소드 정의2 : 반환타입X, 매개변수X 형태로 저의
	-> 전달되는 값 없이 이름을 입력받은 후 namePrint()함수를 호출한다.
	반환값이 없는 경우에는 반드시 void라고 명시해야한다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		메소드를 호출할때 함수의 원형을 그대로 기술하면 된다.
		매개변수가 있가면 갯수만큼 포함시켜줘야한다. 매개변수의
