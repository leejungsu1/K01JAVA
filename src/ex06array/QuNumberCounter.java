...
public class QuNumberCounter {
	...
	public static void main(String[] args) {
		...
		for(int i=0 ; i<answer.length ; i++) {
			//숫자 1이 발견되면 counter배열의 0번방에 +1시켜준다.
...
//			}
//		}
//		System.out.println("count[0] =>"+counter[0]);
//		System.out.println("count[1] =>"+counter[1]);
//		System.out.println("count[2] =>"+counter[2]);
//		System.out.println("count[3] =>"+counter[3]);
	}
}
