...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		을 할당받게 된다. 해당주소를 통해 배열에 접근한다.
		 */
		//크기가 3인 배열이 선언되었으므로 index는 0~2가 생성된다.
		int[] numArr = new int [3];
		numArr[0] = 10;
		numArr[1] = 20;
		numArr[2] = 30;
		System.out.println("numArr의 2번방의 값:"+numArr[2]);
		//배열명(numArr)=[I@7852e922-> 출력하면 주소값(참조값)
		...
		initArr[0] = 100;
		System.out.println("intiArr[0]="+initArr[0]);
		
		/*
		배열의 선언과 동시에 초기화를 하는경우 자바 컴파일러는
